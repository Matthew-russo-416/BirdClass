...
# Set batch size and width of custom layer
batch_size = 32
N = 512
...
# Build our CNN with the custom activation function in the dense layer at the end
...
# Load the Fashion MNIST dataset and normalize the input data.
